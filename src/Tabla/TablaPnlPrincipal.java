...
public class TablaPnlPrincipal {
    ...
    ConsultaPnlPrincipalMuebles cpp = null;
    ...
    public void visualizarMuebles(JTable jtableMuebles) {
        ...
        cpp = new ConsultaPnlPrincipalMuebles();
        PnlPrincipal vo = new PnlPrincipal();
        ArrayList<PnlPrincipal> list = cpp.ListarMuebles();
    ...
    public void visualizarMueblesBuscar(JTable jtableMuebles, String textoBuscar) {
        ...
        cpp = new ConsultaPnlPrincipalMuebles();
        PnlPrincipal vo = new PnlPrincipal();
        ArrayList<PnlPrincipal> list = cpp.BuscarMueble(textoBuscar);

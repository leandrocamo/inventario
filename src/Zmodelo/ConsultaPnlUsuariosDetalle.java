...
public class ConsultaPnlUsuariosDetalle extends Conexion {

    public ArrayList<PnlUsuariosDetalle> ListarBuscarUsuario(String textoBuscar) {
        ArrayList<PnlUsuariosDetalle> list = new ArrayList<PnlUsuariosDetalle>();
...
//        System.out.println("" + sql);
        try {
            ...
            while (rs.next()) {
                ...
                pud.setNro(index++);
                pud.setUsuId(Integer.parseInt(rs.getString("USU.USUID")));

...
public class ConsultaPnlUsuarioDetalle extends Conexion {
    ...
    public ArrayList<PnlUsuarioDetalle> ListarUsuarios() {
...
//        System.out.println("" + sql);
        try {
            ...
            try {
                con.close();
                System.out.println("Conexión cerrada - ListarUsuarios()");
            } catch (SQLException e) {
                System.err.println(e);
            }
        }
    ...
    public ArrayList<PnlUsuarioDetalle> BuscarUsuario(String textoBuscar) {
        ArrayList<PnlUsuarioDetalle> list = new ArrayList<PnlUsuarioDetalle>();
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection con = getConexion();

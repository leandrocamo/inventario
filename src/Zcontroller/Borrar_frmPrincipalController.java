...
import Zvista.Borrar_frmPrincipal;
import Zvista.Borrar_pnlNuevoMueble;
import Zvista.Borrar_pnlPrincipal;
import Zvista.PnlUsuariosDetalle;
import Zvista.PnlUsuarioNuevo;

public class Borrar_frmPrincipalController implements ActionListener {

    Borrar_pnlPrincipal panelPrincipal;
    Borrar_pnlNuevoMueble panelNuevoMueble;
    Borrar_frmPrincipal vPrincipal;
    int clic_tabla = 0;
...
//    PnlUsuarioNuevo punVista = new PnlUsuarioNuevo();
    ...
    public Borrar_frmPrincipalController(Borrar_pnlPrincipal panelPrincipal, Borrar_pnlNuevoMueble panelNuevoMueble, Borrar_frmPrincipal vPrincipal) {
...
//            @Override
                    ...
                    if (value instanceof JButton) {
                        ...
                        if (boton.getName().equals("m")) {
                            try {
                                ...
                                Logger.getLogger(Borrar_frmPrincipal.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == vPrincipal.btnInicio) {
            ...
            try {
                panelNuevoMueble = new Borrar_pnlNuevoMueble(null);
            } catch (ParseException ex) {
                Logger.getLogger(Borrar_frmPrincipal.class.getName()).log(Level.SEVERE, null, ex);
            }
            panelPrincipal.setVisible(false);
            ...
            Borrar_PnlNuevoMuebleController pnc = new Borrar_PnlNuevoMuebleController();

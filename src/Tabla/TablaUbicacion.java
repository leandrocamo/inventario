...
public class TablaUbicacion {
    ...
    public void cargandoRegistros(JTable jTable, String sql) {
        ...
        UbicacionQuery query = new UbicacionQuery();
        UbicacionModel model = new UbicacionModel();
        ArrayList<UbicacionModel> list = null;

//        if (SentenciaSQL == null) {
//            list = query.listarMarcas(null);
//        } else {
        list = query.listarUbicacion(sql);
//        }
        ...
        if (list.size() >= 0) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                fila[3] = model.getAreadependencia();

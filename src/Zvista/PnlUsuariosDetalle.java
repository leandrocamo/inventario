...
import ZTabla.TablaPnlUsuariosDetalle;
import Zclases.TextPrompt;
import java.awt.event.KeyEvent;
import Zmodelo.Conexion;

public class PnlUsuariosDetalle extends javax.swing.JPanel {

    Conexion conexion = new Conexion();
    TablaPnlUsuariosDetalle tabla = new TablaPnlUsuariosDetalle();

    public PnlUsuariosDetalle() {
        initComponents();
